...
const variations = [
	...
	},
	{
		...
		description: __(
			'A field for collecting an email address.',
			'omniform',
		),
	...
	},
	{
		...
		description: __(
			'A field for collecting a username or email address.',
			'omniform',
		),
		keywords: [ 'input', 'username', 'email', 'login' ],
		example: inputTextExample(
			'username-email',
			__( 'Username or Email', 'omniform' ),
		),
	...
	},
	{
		...
		description: __(
			'A field for collecting a website address or URL.',
			'omniform',
		),
	...
	},
	{
		...
		description: __(
			'A field for collecting a numerical value.',
			'omniform',
		),
	...
	},
	{
		...
		description: __(
			'Enter keywords to search for information.',
			'omniform',
		),
	...
	},
	{
		...
		description: __(
			'A field for selecting multiple options or choices.',
			'omniform',
		),
	...
	},
	{
		...
		description: __(
			'A field in a group allowing for one selected choice.',
			'omniform',
		),
	...
	},
	{
		...
		description: __(
			'A field for collecting a formatted date.',
			'omniform',
		),
	...
	},
	{
		...
		description: __(
			'A field for collecting a localized date and time.',
			'omniform',
		),
		keywords: [ 'input', 'calendar', 'time' ],
	...
	},
	{
		...
		description: __(
			'A field for collecting a month formatted date.',
			'omniform',
		),
	...
	},
	{
		...
		description: __(
			'A field for collecting a telephone number.',
			'omniform',
		),
	...
	},
	{
		...
		description: __(
			'A field for collecting a formatted time.',
			'omniform',
		),
	...
	},
	{
		...
		description: __(
			'A field for collecting a week formatted date.',
			'omniform',
		),
		keywords: [ 'input', 'date', 'calendar', 'time' ],
	...
	},
	{
		...
		description: __(
			'A field for selecting a value within a range.',
			'omniform',
		),
	...
	},
	{
		...
		description: __(
			'A field offering multiple options for a single selection.',
			'omniform',
		),
	...
	},
	{
		...
		description: __(
			'A field offering multiple options for multiple selections.',
			'omniform',
		),
		...
		example: {
			...
			innerBlocks: [
				{ name: 'omniform/label' },
				{
					...
					attributes: {
						isMultiple: true,
						style: { dimensions: { minHeight: '130px' } },
					},
					innerBlocks: [
						{
		...
		innerBlocks: [
			{ name: 'omniform/label' },
			{
				...
				attributes: {
					isMultiple: true,
					style: { dimensions: { minHeight: '230px' } },
				},
			},
		],
	},
