...
export const field = (
	<SVG viewBox="0 0 24 24">
		<Path
			fill="#D92E83"
			fillRule="evenodd"
			d="M4 11a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-2a2 2 0 0 0-2-2H4Zm16 2H4v2h16v-2Z"
			clipRule="evenodd"
		/>
...
export const fieldInput = (
	<SVG viewBox="0 0 24 24">
		...
		<Path
			fill="#D92E83"
			fillRule="evenodd"
			d="M2 9a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V9Zm2 0h16v6H4V9Z"
			clipRule="evenodd"
		/>
	</SVG>
);
...
export const fieldHidden = (
	<SVG viewBox="0 0 24 24">
		<Path
			fill="#D92E83"
			fillRule="evenodd"
			d="M4.273 3 3 4.273 5.727 7H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h11.727l4.003 4.003 1.273-1.273L4.273 3ZM4 9h3.727l2 2H6v2h5.727l2 2H4V9Z"
			clipRule="evenodd"
		/>
		<Path
			fill="#D92E83"
			d="M18.819 15H20V9h-7.181l-2-2H20a2 2 0 0 1 2 2v6a2 2 0 0 1-1.305 1.876L18.819 15Z"
		/>
	</SVG>
);
...
export const Button = (
	<SVG viewBox="0 0 24 24">
		...
		<Path
			fill="#D92E83"
			fillRule="evenodd"
			d="M2 8a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V8Zm2 0h16v8H4V8Z"
			clipRule="evenodd"
		/>
	</SVG>
);
...
export const iconReCaptcha = (
	<SVG viewBox="0 0 24 24">
		<Path
			fill="#1C3AA9"
			d="M22 11.986c0-.143-.004-.286-.01-.43V3.44l-2.237 2.244A9.956 9.956 0 0 0 12.015 2 9.958 9.958 0 0 0 4.06 5.962l3.667 3.717a4.868 4.868 0 0 1 1.486-1.672c.64-.501 1.547-.91 2.802-.91a1 1 0 0 1 .355.05 4.833 4.833 0 0 1 3.696 2.233l-2.596 2.604c3.288-.013 7.003-.02 8.53.002Z"
		/>
		<Path
			fill="#4285F4"
			d="M11.957 2c-.143 0-.286.004-.428.01H3.436l2.237 2.244A10.007 10.007 0 0 0 2 12.014c0 3.257 1.55 6.15 3.95 7.979l3.706-3.678a4.864 4.864 0 0 1-1.667-1.49c-.5-.642-.908-1.552-.908-2.81 0-.153.018-.27.051-.356A4.851 4.851 0 0 1 9.36 7.952l2.596 2.603c-.013-3.298-.02-7.023.002-8.555Z"
		/>
		<Path
			fill="#ABABAB"
			d="M2 12.014c0 .144.004.287.01.43v8.116l2.238-2.244A9.956 9.956 0 0 0 11.985 22a9.959 9.959 0 0 0 7.956-3.962l-3.668-3.717a4.869 4.869 0 0 1-1.485 1.672c-.64.501-1.548.911-2.803.911a.998.998 0 0 1-.354-.051 4.833 4.833 0 0 1-3.696-2.233l2.596-2.604c-3.289.013-7.004.02-8.531-.002Z"
		/>
	</SVG>
);
...
export const iconHCaptcha = (
	<SVG viewBox="0 0 24 24">
		...
		<Path
			fill="#0074BF"
			d="M14.5 19.5H12V22h2.5v-2.5ZM12 19.5H9.5V22H12v-2.5Z"
			opacity=".7"
		/>
		...
		<Path
			fill="#008FBF"
			d="M17 14.5h-2.5V17H17v-2.5ZM14.5 14.5H12V17h2.5v-2.5ZM12 14.5H9.5V17H12v-2.5ZM9.5 14.5H7V17h2.5v-2.5Z"
		/>
		...
		<Path
			fill="#009DBF"
			d="M19.5 12H17v2.5h2.5V12ZM17 12h-2.5v2.5H17V12ZM14.5 12H12v2.5h2.5V12ZM12 12H9.5v2.5H12V12ZM9.5 12H7v2.5h2.5V12ZM7 12H4.5v2.5H7V12Z"
		/>
		<Path fill="#009DBF" d="M4.5 12H2v2.5h2.5V12Z" opacity=".7" />
		<Path fill="#00ABBF" d="M22 9.5h-2.5V12H22V9.5Z" opacity=".7" />
		<Path
			fill="#00ABBF"
			d="M19.5 9.5H17V12h2.5V9.5ZM17 9.5h-2.5V12H17V9.5ZM14.5 9.5H12V12h2.5V9.5ZM12 9.5H9.5V12H12V9.5ZM9.5 9.5H7V12h2.5V9.5ZM7 9.5H4.5V12H7V9.5Z"
		/>
		...
		<Path
			fill="#00B9BF"
			d="M17 7h-2.5v2.5H17V7ZM14.5 7H12v2.5h2.5V7ZM12 7H9.5v2.5H12V7ZM9.5 7H7v2.5h2.5V7Z"
		/>
...
export const iconTurnstile = (
	<SVG viewBox="0 0 24 24">
		<Path
			fill="#F38020"
			d="M12.703 3.165a9.406 9.406 0 0 0-6.538 2.377l.595-3.26L5.216 2 4.17 7.724 9.896 8.77l.282-1.545-2.94-.536a7.822 7.822 0 1 1-2.41 3.9l-1.52-.399a9.42 9.42 0 1 0 9.395-7.024Z"
		/>
		<Path
			fill="#F38020"
			fillRule="evenodd"
			d="m18.28 10.253-1.412-1.411-5.538 5.538-2.202-2.201-1.414 1.413 3.62 3.62 1.413-1.415-.006-.005 5.539-5.539Z"
			clipRule="evenodd"
		/>
	</SVG>
);
...
export const iconItemMarkRead = (
	<SVG viewBox="0 0 24 24">
		<Path
			fill="#D92E83"
			d="m15.95 22-4.25-4.25 1.4-1.4 2.85 2.85 5.65-5.65 1.4 1.4zM12 11l8-5H4zm0 2L4 8v10h5.15l2 2H4q-.824 0-1.412-.587A1.93 1.93 0 0 1 2 18V6q0-.824.587-1.412A1.93 1.93 0 0 1 4 4h16q.824 0 1.413.588Q22 5.175 22 6v4.35l-2 2V8z"
		/>
	</SVG>
);
...
export const iconItemMarkSpam = (
	<SVG viewBox="0 0 24 24">
		<Path
			fill="#D92E83"
			d="M12 17q.424 0 .713-.288A.97.97 0 0 0 13 16a.97.97 0 0 0-.287-.713A.97.97 0 0 0 12 15a.97.97 0 0 0-.713.287A.97.97 0 0 0 11 16q0 .424.287.712.288.288.713.288m-1-4h2V7h-2zm-2.75 8L3 15.75v-7.5L8.25 3h7.5L21 8.25v7.5L15.75 21zm.85-2h5.8l4.1-4.1V9.1L14.9 5H9.1L5 9.1v5.8z"
		/>
	</SVG>
);
