 ...
 */
import { Defs, LinearGradient, Path, Stop, SVG } from '@wordpress/primitives';

export const form = (
	<SVG viewBox="0 0 24 24">
		<Path fill="url(#omniform-icon-gradient)" fillRule="evenodd"
...
export const fieldInput = (
	<SVG viewBox="0 0 24 24">
		<Path fill="url(#omniform-icon-gradient)" d="M14 11H6v2h8v-2Z" />
		<Path fill="url(#omniform-icon-gradient)" fillRule="evenodd"
...
export const fieldEmail = (
	<SVG xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none">
		<Path fill="url(#omniform-icon-gradient)"
...
export const fieldRadio = (
	<SVG viewBox="0 0 24 24">
		<Path fill="url(#omniform-icon-gradient)" d="M17 12a5 5 0 1 1-10 0 5 5 0 0 1 10 0Z" />
		<Path fill="url(#omniform-icon-gradient)" fillRule="evenodd"
...
export const fieldTextarea = (
	<SVG viewBox="0 0 24 24">
		<Path fill="url(#omniform-icon-gradient)" d="M18 9H6v2h12V9Z" />
		<Path fill="url(#omniform-icon-gradient)" d="M6 13h8v2H6v-2Z" />
		<Path fill="url(#omniform-icon-gradient)" fillRule="evenodd"
...
export const fieldSelect = (
	<SVG viewBox="0 0 24 24">
		<Path fill="url(#omniform-icon-gradient)" d="M6 7h8v2H6V7Z" />
		<Path fill="url(#omniform-icon-gradient)" d="M14 11H6v2h8v-2Z" />
		<Path fill="url(#omniform-icon-gradient)" d="M6 15h8v2H6v-2Z" />
		<Path fill="url(#omniform-icon-gradient)" d="M18 7h-2v2h2V7Z" />
		<Path fill="url(#omniform-icon-gradient)" fillRule="evenodd"
...
export const selectGroup = (
	<SVG viewBox="0 0 24 24">
		<Path fill="url(#omniform-icon-gradient)" d="M14 10H3v2h11v-2Zm0-4H3v2h11V6Zm4 8v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4ZM3 16h7v-2H3v2Z" />
		<Defs>
			<LinearGradient id="omniform-icon-gradient" x1="0" x2="24" y1="0" y2="24" gradientUnits="userSpaceOnUse">
				<Stop stopColor="#842ED9" />
				<Stop offset=".5" stopColor="#D92E83" />
...
export const fieldGroup = (
	<SVG viewBox="0 0 24 24">
		<Path fill="url(#omniform-icon-gradient)" d="M7 7h2v2H7V7Z" />
		<Path fill="url(#omniform-icon-gradient)" d="M9 11H7v2h2v-2Z" />
		<Path fill="url(#omniform-icon-gradient)" d="M7 15h2v2H7v-2Z" />
		<Path fill="url(#omniform-icon-gradient)" d="M17 11h-6v2h6v-2Z" />
		<Path fill="url(#omniform-icon-gradient)" d="M11 15h6v2h-6v-2Z" />
		<Path fill="url(#omniform-icon-gradient)" d="M17 7h-6v2h6V7Z" />
		<Path fill="url(#omniform-icon-gradient)" fillRule="evenodd"
...
export const Button = (
	<SVG viewBox="0 0 24 24">
		<Path fill="url(#omniform-icon-gradient)" d="M17 11H7v2h10v-2Z" />
		<Path fill="url(#omniform-icon-gradient)" fillRule="evenodd"
