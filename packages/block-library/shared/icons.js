...
export const iconItemView = (
	<SVG viewBox="0 0 24 24">
		<Path fill="#D92E83" d="M12 16q1.875 0 3.188-1.312Q16.5 13.375 16.5 11.5t-1.312-3.187T12 7 8.813 8.313Q7.499 9.625 7.5 11.5q0 1.875 1.313 3.188Q10.125 16 12 16m0-1.8q-1.125 0-1.912-.787A2.6 2.6 0 0 1 9.3 11.5q0-1.125.787-1.912A2.6 2.6 0 0 1 12 8.8q1.125 0 1.912.787.788.788.788 1.913t-.787 1.912A2.6 2.6 0 0 1 12 14.2m0 4.8q-3.65 0-6.65-2.038T1 11.5q1.35-3.425 4.35-5.462T12 4t6.65 2.037q3 2.039 4.35 5.463-1.35 3.425-4.35 5.462T12 19m0-2a9.54 9.54 0 0 0 5.188-1.488A9.77 9.77 0 0 0 20.8 11.5a9.77 9.77 0 0 0-3.613-4.012A9.55 9.55 0 0 0 12 6a9.55 9.55 0 0 0-5.187 1.487A9.77 9.77 0 0 0 3.2 11.5a9.77 9.77 0 0 0 3.613 4.012A9.54 9.54 0 0 0 12 17" />
	</SVG>
);

export const iconItemTrash = (
	<SVG viewBox="0 0 24 24">
		<Path fill="#D92E83" d="M7 21q-.824 0-1.412-.587A1.93 1.93 0 0 1 5 19V6H4V4h5V3h6v1h5v2h-1v13q0 .824-.587 1.413A1.93 1.93 0 0 1 17 21zM17 6H7v13h10zM9 17h2V8H9zm4 0h2V8h-2z" />
	</SVG>
);

export const iconItemMarkRead = (
	<SVG viewBox="0 0 24 24">
		<Path fill="#D92E83" d="m15.95 22-4.25-4.25 1.4-1.4 2.85 2.85 5.65-5.65 1.4 1.4zM12 11l8-5H4zm0 2L4 8v10h5.15l2 2H4q-.824 0-1.412-.587A1.93 1.93 0 0 1 2 18V6q0-.824.587-1.412A1.93 1.93 0 0 1 4 4h16q.824 0 1.413.588Q22 5.175 22 6v4.35l-2 2V8z" />
	</SVG>
);

export const iconItemMarkUnread = (
	<SVG viewBox="0 0 24 24">
		<Path fill="#D92E83" d="M4 20q-.824 0-1.412-.587A1.93 1.93 0 0 1 2 18V6q0-.824.587-1.412A1.93 1.93 0 0 1 4 4h10.1a5.1 5.1 0 0 0 0 2H4l8 5 3.65-2.275q.35.325.763.563.412.237.862.412L12 13 4 8v10h16V9.9q.575-.125 1.075-.35T22 9v9q0 .824-.587 1.413A1.93 1.93 0 0 1 20 20zM19 8a2.9 2.9 0 0 1-2.125-.875A2.9 2.9 0 0 1 16 5q0-1.25.875-2.125A2.9 2.9 0 0 1 19 2q1.25 0 2.125.875T22 5t-.875 2.125A2.9 2.9 0 0 1 19 8" />
	</SVG>
);

export const iconItemMarkSpam = (
	<SVG viewBox="0 0 24 24">
		<Path fill="#D92E83" d="M12 17q.424 0 .713-.288A.97.97 0 0 0 13 16a.97.97 0 0 0-.287-.713A.97.97 0 0 0 12 15a.97.97 0 0 0-.713.287A.97.97 0 0 0 11 16q0 .424.287.712.288.288.713.288m-1-4h2V7h-2zm-2.75 8L3 15.75v-7.5L8.25 3h7.5L21 8.25v7.5L15.75 21zm.85-2h5.8l4.1-4.1V9.1L14.9 5H9.1L5 9.1v5.8z" />
	</SVG>
);
