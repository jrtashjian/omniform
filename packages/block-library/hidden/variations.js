...
const variations = [
	{
		...
		description: __(
			'Hidden input field to store the current user ID.',
			'omniform',
		),
		attributes: {
			fieldName: 'get_current_user_id',
			fieldValue: '{{ get_current_user_id }}',
		},
	},
	{
		...
		attributes: {
			fieldName: 'get_search_query',
			fieldValue: '{{ get_search_query }}',
		},
	},
	{
		...
		description: __(
			'Hidden input field to store the user locale.',
			'omniform',
		),
		attributes: {
			fieldName: 'get_user_locale',
			fieldValue: '{{ get_user_locale }}',
		},
	},
];
