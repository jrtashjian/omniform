		...
		add_action(
			...
			function () {
				if ( isset( $_POST['connect_api'] ) && isset( $_GET['page'] ) && 'omniform' === $_GET['page'] ) {
					...
					/** @var \OmniForm\OAuth\TokenStorage */ // phpcs:ignore
					$token_storage = omniform()->get( \OmniForm\OAuth\TokenStorage::class );
					/** @var \OmniForm\OAuth\OAuthManager */ // phpcs:ignore
					$oauth_manager = omniform()->get( \OmniForm\OAuth\OAuthManager::class );
		...
		add_action(
			...
			function () {
				add_submenu_page(
					...
					'omniform',
					function () {
						/** @var \OmniForm\OAuth\ApiClient */ // phpcs:ignore
						$api_client = omniform()->get( \OmniForm\OAuth\ApiClient::class );
						/** @var \OmniForm\OAuth\TokenStorage */ // phpcs:ignore
						$token_storage = omniform()->get( \OmniForm\OAuth\TokenStorage::class );
						...
						<div id="omniform">
							...
							<?php if ( $token_storage->get_access_token() ) : ?>
							<form method="post">
