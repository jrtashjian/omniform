 ...
 * Tests the SelectOption class.
 */
class SelectOptionTest extends FormBlockTestCase {
	/**
	 * Register the block to test against.
	 */
	public function set_up() {
		$this->register_block_type( new SelectOptionBlock() );
	}
...
// phpcs:disable
class SelectOptionBlock extends SelectOption {
